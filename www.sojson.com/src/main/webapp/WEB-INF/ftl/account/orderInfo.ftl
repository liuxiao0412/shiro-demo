                                        ...
                                        <div class="box-body table-responsive no-padding">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>1</td>
                                                    <td><span class="label label-success">正式单据</span></td>
                                                    <td>201711190008</td>
                                                    <td>2017-11-11 11：23</td>
                                                    <td>张三</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <button type="button" class="btn  btn-sm   btn-default">打印
                                                            </button>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>1</td>
                                                    <td><span class="label label-danger">意向单</span></td>
                                                    <td>201711190008</td>
                                                    <td>2017-11-11 11：23</td>
                                                    <td>张三</td>
                                                    <td>HRB400E</td>
